...
%***   计算指标并比较***%
        ...
        new_object    = chap3_4obj(cross_Path_spline,distance_cross(i,:),0);   %计算交叉后的能量消耗最低及路径逼近最佳值的和
        formal_object = chap3_4obj(Path_spline,distance_Path(i,:),0);          %计算插值后的能量消耗最低及路径逼近最佳值的和
